...
#define CPU_TO_MEM__WE__FIELD
#define CPU_TO_MEM__WE__WIDTH
#define CPU_TO_MEM__ADDR__FIELD
...
( 
    .clk(clk),
    .rst(rst),
    .tx__valid(cpu_to_mem__valid),
    .tx__ready(cpu_to_mem__ready),
    .tx__data(cpu_to_mem__data),
    .valid(cpu_to_mem__tx__valid),
    .credit(cpu_to_mem__tx__credit),
    .data(cpu_to_mem__tx__data)
);
