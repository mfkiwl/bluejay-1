...
#
# Generated by Vivado on Sat May 07 19:59:33 -0400 2022
...
# Script info
echo -e "main_memory.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot main_memory xil_defaultlib.main_memory xil_defaultlib.glbl -log elaborate.log
}
